...
const Navbar = ({selectedPage, setSelectedPage}: Props) => {
    ...
    const navBarBackground = isTopOfPage ? "" : "bg-primary-100 drop-shadow  z-[50]"
  ...
  return <nav>
    ...
    {!isAboveMediumScreen && isMenuToggled  && (
        <div className="fixed right-0 bottom-0 h-full w-[300px] bg-primary-100 drop-shadow-x z-[60]">
            {/* CLOSE ICON */}
